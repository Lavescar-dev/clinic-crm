...
import type { MedicalRecord, Diagnosis, Prescription, Medication } from '$types';
import type { LabResult } from '$lib/types/emr';
import { nanoid } from 'nanoid';
import { mockUsers } from './users';
import { mockPatients } from './patients';
import { mockAppointments } from './appointments';

const doctors = browser ? mockUsers.filter((u) => u.role === 'doctor') : [];
...
// Only generate medical records in browser to avoid SSR issues
if (browser) {
